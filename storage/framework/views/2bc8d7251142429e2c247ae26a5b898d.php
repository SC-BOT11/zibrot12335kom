...
<body class="bg-gray-100">
    <div class="min-h-screen flex items-center justify-center">
        <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
            ...
            <form action="<?php echo e(route('register.submit')); ?>" method="POST" novalidate>
                <?php echo csrf_field(); ?>
                ...
                <div class="mb-4">
                    ...
                    <textarea id="address" name="address" required rows="3"
                           class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"><?php echo e(old('address')); ?></textarea>
                </div>
            ...
            <div class="mt-4 text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="text-blue-500 hover:text-blue-700">Login here</a>
                </p>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\backend-ujikom\resources\views/auth/register.blade.php ENDPATH**/ ?>